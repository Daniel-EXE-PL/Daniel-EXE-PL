...
- **` 📂 ` [LifeSync Roleplay (LSR)](https://github.com/LifeSyncRoleplay)**  
...
![Logo](https://skillicons.dev/icons?i=css,html,java,js,lua,py,go,php)

**Frameworks und Libraries**

![Logo](https://skillicons.dev/icons?i=react,tailwind,nodejs,discordjs,bots)
